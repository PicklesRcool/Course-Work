...
std::string Element::getCompleteName() const
{
...
std::string Element::getSurname() const
{
    return theSurname;
}

std::string Element::getFatherCompleteName() const
{
    return ( this->theFatherName + std::string(" ") + this->theFatherSurname );
}

std::string Element::getMotherCompleteName() const
{
    return ( this->theMotherName + std::string(" ") + this->theMotherSurname );
}

Element::TGender Element::getGender() const
{
    return theGender;
}

std::string Element::getBirthDate() const
{
    char buffer [11];
...
std::string Element::getBirthLocation() const
{
